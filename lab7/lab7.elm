...
init : () -> ( Model, Cmd Msg )
init _ = -- _ means I don’t care
 ( { name = "", password="", passwordAgain = "", response = "" }, Cmd.none) -- Runs testGet at the start	
...
testPost thisName thisPassword=
  Http.post
    { url = "https://mac1xa3.ca/e/liy443/lab7/"
    , body = Http.stringBody "application/x-www-form-urlencoded" ("name=" ++ thisName ++ "&password="++ thisPassword)
...
view model =
  div []
    ...
    , div [ style "color" "green" ] [ text model.response]
    ]
